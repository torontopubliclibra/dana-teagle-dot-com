let tplNow = {
    ...
    functions: {
        nowDisplay: () => {
            ...
            formattedNow.push(`<hr><p>>> last watched ( <a href="/letterboxd" target="_blank">letterboxd</a> | <a href="/tpl/logs#movies" target="_blank">see more</a> ):</p>`);
            ...
            formattedNow.push(`<p>>> last read ( <a href="/goodreads" target="_blank">goodreads</a> | <a href="/tpl/logs#books" target="_blank">see more</a> ):</p>`);
            ...
            formattedNow.push(`<p>>> latest mixes ( <a href="/tidal" target="_blank">tidal</a> | <a href="/tpl/mixes" target="_blank">see more</a> ):</p>`);
