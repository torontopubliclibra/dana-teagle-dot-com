let tplFeed = {
    ...
    functions: {
        ...
        updateToggle: () => {
            ...
            toggleText += '</span>';
            toggleText += '<span style="border-bottom: solid white 0.5px;margin-bottom: 4px;"><a href="/tpl/rss.xml" target="_blank" style="margin-left:auto;margin-bottom: -3px; display: flex; align-items: center; text-decoration:none;gap: 8px; color: #f3e8e9; font-size: 1.1em;" title="RSS Feed">RSS';
