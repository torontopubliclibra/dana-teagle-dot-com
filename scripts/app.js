...
const app = {
    ...
    functions: {
        ...
        renderTestimonialButton() {
            ...
            app.elements.testimonialsButton.innerHTML = `<span class="testimonial-button-dots" aria-hidden="true">${testimonialDots}</span> <span class="testimonial-button-label">Another <img src="./assets/icons/refresh.svg" alt="" srcset=""></span>`;
